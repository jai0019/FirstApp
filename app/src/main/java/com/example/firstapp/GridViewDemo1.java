...
public class GridViewDemo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al.add(new Student(4,"MNO","http://lorempixel.com/400/200/sports?q=1"));
        al.add(new Student(5,"MNO","http://lorempixel.com/400/200/sports?q=2"));
        al.add(new Student(6,"MNO","http://lorempixel.com/400/200/sports?q=3"));
        al.add(new Student(7,"MNO","http://lorempixel.com/400/200/sports?q=4"));
    ...
    class myadapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null) {
                ...
                convertView = l.inflate(R.layout.single_row_design2, parent, false);
            }
